...
export const Skills: React.FC<SkillsProps> = (props) => {
  ...
  const xLeft50 = useTransform(scrollYspring, [0.3, 0.55], ["0vw", "-65vw"]);
  const xRight50 = useTransform(scrollYspring, [0.3, 0.55], ["0vw", "65vw"]);
  const xLeft45 = useTransform(scrollYspring, [0.35, 0.55], ["0vw", "-65vw"]);
  const xRight45 = useTransform(scrollYspring, [0.35, 0.55], ["0vw", "65vw"]);
  const xLeft40 = useTransform(scrollYspring, [0.4, 0.55], ["0vw", "-65vw"]);
  const xRight40 = useTransform(scrollYspring, [0.4, 0.55], ["0vw", "65vw"]);
